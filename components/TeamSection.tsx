    ...
    <section ref={sectionRef} className="w-full pb-10">
      <div className="flex flex-col mb-10">
          ...
          <p className="text-xl font-medium mt-5">
            Somos un equipo interdisciplinar de mujeres 
            que aportan desde distintos saberes. Nos hemos 
            unido para crear un espacio acogedor y educativo, 
            ofreciendo apoyo a aquellos que han enfrentado el 
            desafío del cáncer y sus tratamientos.
          </p>
      </div>
